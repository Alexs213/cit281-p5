...
//this.notalive= false
  ...
  this.monsterList.forEach((currentmonster) => {
    `Monster: ${currentmonster.monsterName}, Minimum Life : ${currentmonster.minimumLife}, Current Life : ${currentmonster.currentLife} Status: Alive`,
    `Monster: ${currentmonster.monsterName}, Minimum Life : ${currentmonster.minimumLife}, Current Life : ${currentmonster.currentLife} Status: Alive`
  })
